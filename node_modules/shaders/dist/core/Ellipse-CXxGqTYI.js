...
const componentDefinition = {
	...
	fragmentNode: ({ uniforms }) => {
		...
		const sdf = ellipseSdf(dx.mul(cosR).add(dy.mul(sinR)), dy.mul(cosR).sub(dx.mul(sinR)), uniforms.radiusX.uniform, uniforms.radiusY.uniform);
...
export { componentDefinition as n, Ellipse_default as t };
