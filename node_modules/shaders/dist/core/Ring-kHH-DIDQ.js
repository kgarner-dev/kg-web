...
const componentDefinition = {
	...
	fragmentNode: ({ uniforms }) => {
		...
		const sdf = ringSdf(aspectUV.x.sub(centerPos.x), aspectUV.y.sub(centerPos.y), uniforms.radius.uniform, uniforms.thickness.uniform);
