...
const componentDefinition = {
	...
	fragmentNode: ({ uniforms }) => {
		...
		const sdf = crossSdf(dx.mul(cosR).add(dy.mul(sinR)), dy.mul(cosR).sub(dx.mul(sinR)), uniforms.radius.uniform, uniforms.thickness.uniform, uniforms.rounding.uniform);
...
export { componentDefinition as n, Cross_default as t };
